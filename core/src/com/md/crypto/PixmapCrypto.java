 ...
 */
public class PixmapCrypto implements Disposable {
	/**
	...
	public enum Format {
		...
		public static Format fromGdx2DPixmapFormat(int format) {
			...
			if (format == Gdx2DPixmap.GDX2D_FORMAT_RGBA8888)
				return RGBA8888;
			throw new GdxRuntimeException("Unknown Gdx2DPixmap Format: "
					+ format);
		}
	}
	...
	public static void setBlending(Blending blending) {
		PixmapCrypto.blending = blending;
	...
	public static void setFilter(Filter filter) {
		Gdx2DPixmap
				.setScale(filter == Filter.NearestNeighbour ? Gdx2DPixmap.GDX2D_SCALE_NEAREST
	...
	public PixmapCrypto(byte[] encodedData, int offset, int len) {
		try {
			...
			throw new GdxRuntimeException(
					"Couldn't load pixmap from image data", e);
		}
	}
...
//			XorEncrypto.decryp(bytes, 10);
	 ...
	 * @param pixmap
	 */
	public PixmapCrypto(Gdx2DPixmap pixmap) {
		this.pixmap = pixmap;
	}
	 ...
	 */
	public void drawPixmap(PixmapCrypto pixmap, int x, int y) {
	 ...
	 */
	public void drawPixmap(PixmapCrypto pixmap, int x, int y, int srcx,
			int srcy, int srcWidth, int srcHeight) {
		this.pixmap.drawPixmap(pixmap.pixmap, srcx, srcy, x, y, srcWidth,
				srcHeight);
	}
	 ...
	 *            the target height
	 */
	public void drawPixmap(PixmapCrypto pixmap, int srcx, int srcy,
